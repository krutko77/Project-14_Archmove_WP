(() => {
          ...
          return (
            ...
            !0 === o.options.swipeToSlide
              ? (o.$slideTrack.find(".slick-slide").each(function (s, n) {
                  if (
                    n.offsetLeft - i + e(n).outerWidth() / 2 >
                    -1 * o.swipeLeft
                  )
                    return (t = n), !1;
                }),
          ...
          t.$slides
            ...
            null !== t.$dots &&
              ...
              t.$dots
                ...
                .end());
          for (
            var s = t.currentSlide, n = s + t.options.slidesToShow;
            s < n;
            s++
          )
    ...
    (i = function (e) {
      ...
      (v.prototype = {
        ...
        open: function (i) {
          ...
          if (!t.isOpen) {
            (t.types = []),
              ...
              t.bgOverlay ||
                ((t.bgOverlay = S("bg").on("click" + f, function () {
                  t.close();
                })),
                (t.wrap = S("wrap")
                  .attr("tabindex", -1)
              ...
              t.st.preloader &&
                (t.preloader = S("preloader", t.container, t.st.tLoading));
        ...
        updateItemHTML: function () {
          ...
          var o = i.type;
          if (
            (T("BeforeChange", [t.currItem ? t.currItem.type : "", o]),
            (t.currItem = i),
            !t.currTemplate[o])
          ) {
        ...
        addGroup: function (e, i) {
          ...
          (i.mainEl = e),
            i.items
              ? ((i.isObj = !0), e.off(s).on(s, o))
              : ((i.isObj = !1),
                i.delegate
                  ? e.off(s).on(s, i.delegate, o)
                  : ((i.items = e), e.off(s).on(s, o)));
        },
          ...
          getInline: function (i, o) {
            if ((P(), i.src)) {
              ...
              if (n.length) {
                ...
                r &&
                  r.tagName &&
                  (x || (($ = s.hiddenClass), (x = S($)), ($ = "mfp-" + $)),
                  (A = n.after(x).detach().removeClass($))),
            ...
            return (
              ...
              !(!i || !i.enabled) &&
                ...
                k("UpdateStatus" + s, function (e, i) {
                  i.text &&
                    (i.text = D(i.text, t.currItem.index, t.items.length));
                }),
                k(d + s, function (e, o, s, n) {
                  var r = t.items.length;
                  s.counter = r > 1 ? D(i.tCounter, n.index, r) : "";
                }),
  ...
  const o = document.querySelector(".header__menu-icon"),
  ...
  const r = document.querySelector(".go-top");
  ...
  let a = document.querySelectorAll('a[href="#top"]');
  for (let e of a)
